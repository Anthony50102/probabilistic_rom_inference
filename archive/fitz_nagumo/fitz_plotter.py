...
class FitzPlotter(Plotter):
    ...
    def operator_plot(
        ...
        for i in range(samples):
            ...
            rom.model.predict(state0=q0, t=self.time_domain_eval_training, input_func=input_func, method=ivp_method)
            ...
            rom.model.predict(state0=q0, t=self.time_domain_eval_prediction, input_func=input_func, method=ivp_method)
