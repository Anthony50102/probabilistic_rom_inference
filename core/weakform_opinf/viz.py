...
from core.plotting.result import _metrics
...
def _to_run_result(result, method_name):
    ...
    for et, pt in zip(result["eval_targets"], result["per_target"]):
        ...
        targets.append(TargetResult(
            ...
            t_samp=et.t_sampled, snapshots_comp=et.snapshots_comp,
            is_training=et.training_index is not None,
    ...
    return RunResult(
        ...
        runtime=result.get("runtime", float("nan")), metrics=_metrics(result))
