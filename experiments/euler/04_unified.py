"""
04_unified.py — Marginalised-O × Weak-Form Bayesian OpInf (Compressible Euler).
...
class EulerSpec:
    """ExperimentSpec adapter: compressible Euler PDE solve → autonomous cAH ROM."""
...
def main(schema_names=None):
    ...
    if not schemas:
        ...
        return
    print("=" * 78)
    print("04_unified — Marginalised-O × Weak-Form (Compressible Euler)")
    print("=" * 78)
