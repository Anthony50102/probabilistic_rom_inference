# config.py
"""Configuration for Cubic Heat equation experiments.

This experiment reduces the lifted variables (q, q^2) jointly and 
...
# Input parameters for training trajectories
input_parameters = (
    (-2, 0),
    (-1, -2),
    (0, 1),
...
class FullOrderModel(pdes.CubicHeatBimodal):
    """Full-order model for cubic heat equation."""
...
class ReducedOrderModel(opinf.models.ContinuousModel):
    """Reduced-order model for cubic heat equation."""
